        ...
        if($query = mysqli_query($db, $sql)){
            if(mysqli_num_rows($query) > 0){
                while($row = mysqli_fetch_array($query)){
                        ...
                        <h1 class="text-break text-center"><b>"' . nl2br($row['text']) . '"</b></h1></div>';
            ...
            echo "ERROR: Could not able to execute $sql. " . mysqli_error($link);
                ...
                <!--
                        <h1><b>text bucin</b></h1>
                    </div>
                    <div class="col-xs-6 tengah justify-content-center">
                        <p><i>- Author -</i></p> -->
                    </div>
            </div>
        </div>
